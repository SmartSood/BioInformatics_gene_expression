...
class BaseTrainingRun(_PrismaModel):
    __prisma_model__: ClassVar[Literal['TrainingRun']] = 'TrainingRun'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.TrainingRunActions[_PrismaModelT]':
        from .client import get_client
